...
const newToDo = new (0, _todo.ToDoList)();
function displayTodos() {
    ...
    tasks.forEach((todo, index)=>{
        ...
        if (todo.completed) todoItem.style.backgroundColor = "#90EE90";
...
formEl.addEventListener("submit", (event)=>{
    ...
    } else alert("Skriv in korrekt uppgift och prioritet");
});
window.addEventListener("load", displayTodos);

},{"../../todo":"92xLS"}],"92xLS":[function(require,module,exports) {
...
class ToDoList {
    addTodo(task, priority) {
        if (typeof task !== "string" || typeof priority !== "number" || priority < 1 || priority > 3) return false;
...
},{}]},["3L0Bc","hYrgI"], "hYrgI", "parcelRequire124b")
